...
png(filename = './output/active/opt/base.png',width = 6,height = 6,units = 'in',res = 500)
...
#save the base here
writeRaster(x = base,filename = './output/active/opt/base_all_towers.tif',overwrite = T)
...
top$site = substr(top$sitename,start = 0,stop = 30)

png(filename = './output/active/barplot_reduction.png',width = 6,height = 4,units = 'in',res = 2000)
ggplot(data = top)+theme_bw()+ggtitle('Top 50 Percentile Improvements')+
  ...
  scale_y_continuous(expand = c(0,0),limits = c(0,0.08),'Mean ED Reduction')+
  scale_x_discrete('')+
  scale_fill_brewer(palette = "Spectral")+
  theme(axis.text.x = element_text(angle = 90,hjust = 1,vjust = 0.15,size = 5),
...
############################
#add Yessey to the already decided sites
############################
...
pca.towers1$support = ifelse(pca.towers1$sitename == 'Resolute' |
                              pca.towers1$sitename == 'Kangiqsualujjuaq' |
                              pca.towers1$sitename == 'Yessey',
                            'yes',pca.towers1$support)
...
png(filename = './output/active/opt/base1/base.png',width = 6,height = 6,units = 'in',res = 500)
ggplot()+theme_bw()+ggtitle('All Active Sites')+
  geom_polygon(data = wm,aes(x = long,y=lat,group=group),
               fill = 'gray80',lwd = 0.25)+
  layer_spatial(base.ster$base.dist)+
  geom_point(data = towers.st,aes(x.1,y.1),col='black',fill='green',pch=25,size=2)+
  geom_point(data = subset(towers.st,towers.st$support == 'yes'),
             aes(x.1,y.1),col='black',fill='cyan',pch=25,size=2)+
  scale_fill_gradientn('ED',
                       na.value = 'transparent',
                       colours = pal,
                       #trans = 'log',
...
#save the base here
writeRaster(x = base,filename = './output/active/opt/base1/base_all_towers.tif',overwrite = T)
...
#create a path of file names
path = paste('./output/active/opt/base1/ext/',pca.towers$sitename[ext],'.tif',sep = '')
#save off rasters
for (i in 1:length(dist.rasts)) {
  writeRaster(x = dist.rasts[[i]],filename = path[i],overwrite=T)
  progress(i,length(dist.rasts))
...
#save off difference maps
path = paste('./output/active/opt/base1/difs/',pca.towers1$sitename[ext],'_dif.tif',sep = '')
#save off rasters
for (i in 1:length(difs)) {
  writeRaster(x = difs[[i]],filename = path[i],overwrite=T)
  progress(i,length(difs))
...
png(filename = './output/active/opt/base1/barplot_reduction.png',width = 6,height = 4,units = 'in',res = 2000)
ggplot(data = top)+theme_bw()+ggtitle('Top 50 Percentile Improvements')+
  geom_bar(aes(reorder(site, -means*-1),means*-1,fill=country),stat = 'identity')+
  scale_y_continuous(expand = c(0,0),limits = c(0,0.08),'Mean ED Reduction')+
  scale_x_discrete('')+
...
write.csv(x = bars,file = './output/active/opt/base1/meanreduction.csv',row.names = F)
...
#plot
path = paste('./output/active/opt/base1/plots/',pca.towers1$sitename[ext],'_dif.png',sep = '')

#create a dataframe and reproject the tower locations for plotting
towers = SpatialPointsDataFrame(coords = pca.towers1[ext,c(1,2)],data = pca.towers1[ext,],proj4string = crs(base))
towers = spTransform(x = towers,CRSobj = proj)
towers.st = as.data.frame(towers)

for (i in 1:length(dif.ster)) {
  png(filename = path[i],width = 5,height = 5,units = 'in',res = 500)
  plots =   ggplot()+theme_bw()+ggtitle(pca.towers1$sitename[ext][i])+
    geom_polygon(data = wm,aes(x = long,y=lat,group=group),
                 fill = 'gray80',lwd = 0.25)+
    layer_spatial(dif.ster[[i]])+
    geom_point(data = towers.st,aes(x.1[i],y.1[i]),col='black',fill='green',pch=25)+
...
png(filename = './output/active/opt/base2/base.png',width = 6,height = 6,units = 'in',res = 500)
ggplot()+theme_bw()+ggtitle('All Active Sites')+
  geom_polygon(data = wm,aes(x = long,y=lat,group=group),
               fill = 'gray80',lwd = 0.25)+
  layer_spatial(base.ster$base.dist)+
...
#save the base here
writeRaster(x = base,filename = './output/active/opt/base2/base_all_towers.tif',overwrite = T)
...
#create a path of file names
path = paste('./output/active/opt/base2/ext/',pca.towers1$sitename[ext],'.tif',sep = '')
#save off rasters
for (i in 1:length(dist.rasts)) {
  writeRaster(x = dist.rasts[[i]],filename = path[i],overwrite=T)
  progress(i,length(dist.rasts))
...
#save off difference maps
path = paste('./output/active/opt/base2/difs/',pca.towers1$sitename[ext],'_dif.tif',sep = '')
#save off rasters
for (i in 1:length(difs)) {
  writeRaster(x = difs[[i]],filename = path[i],overwrite=T)
  progress(i,length(difs))
...
png(filename = './output/active/opt/base2/barplot_reduction.png',width = 6,height = 4,units = 'in',res = 2000)
ggplot(data = top)+theme_bw()+ggtitle('Top 50 Percentile Improvements')+
  geom_bar(aes(reorder(site, -means*-1),means*-1,fill=country),stat = 'identity')+
  scale_y_continuous(expand = c(0,0),limits = c(0,0.08),'Mean ED Reduction')+
  scale_x_discrete('')+
...
write.csv(x = bars,file = './output/active/opt/base2/meanreduction.csv',row.names = F)
...
#plot
path = paste('./output/active/opt/base2/plots/',pca.towers1$sitename[ext],'_dif.png',sep = '')
...
############################
#add Resolute and kangiq, yessey, kular,  pond inlet
...
net = which(pca.towers1$active == 'active')
ext = which(is.na(pca.towers1$active) | pca.towers1$active != 'active')
...
png(filename = './output/active/opt/base3/base.png',width = 6,height = 6,units = 'in',res = 500)
ggplot()+theme_bw()+ggtitle('All Active Sites')+
  geom_polygon(data = wm,aes(x = long,y=lat,group=group),
               fill = 'gray80',lwd = 0.25)+
  layer_spatial(base.ster$base.dist)+
...
#save the base here
writeRaster(x = base,filename = './output/active/opt/base3/base_all_towers.tif',overwrite = T)
...
#create a path of file names
path = paste('./output/active/opt/base3/ext/',pca.towers1$sitename[ext],'.tif',sep = '')
#save off rasters
for (i in 1:length(dist.rasts)) {
  writeRaster(x = dist.rasts[[i]],filename = path[i],overwrite=T)
  progress(i,length(dist.rasts))
...
#save off difference maps
path = paste('./output/active/opt/base3/difs/',pca.towers1$sitename[ext],'_dif.tif',sep = '')
#save off rasters
for (i in 1:length(difs)) {
  writeRaster(x = difs[[i]],filename = path[i],overwrite=T)
  progress(i,length(difs))
...
png(filename = './output/active/opt/base3/barplot_reduction.png',width = 6,height = 4,units = 'in',res = 2000)
ggplot(data = top)+theme_bw()+ggtitle('Top 50 Percentile Improvements')+
  geom_bar(aes(reorder(site, -means*-1),means*-1,fill=country),stat = 'identity')+
  scale_y_continuous(expand = c(0,0),limits = c(0,0.08),'Mean ED Reduction')+
  scale_x_discrete('')+
...
write.csv(x = bars,file = './output/active/opt/base3/meanreduction.csv',row.names = F)
...
#plot
path = paste('./output/active/opt/base3/plots/',pca.towers1$sitename[ext],'_dif.png',sep = '')
...
##############################################################
#add Resolute, kangiq, Yessey, Kular, Pond Inlet, CEF
##############################################################
pca.towers1 = pca.towers
...
towers = SpatialPointsDataFrame(coords = pca.towers1[net,c('x','y')],data = pca.towers1[net,],proj4string = crs(base))
towers = spTransform(x = towers,CRSobj = proj)
towers.st = as.data.frame(towers)
...
png(filename = './output/active/opt/base4/base.png',width = 6,height = 6,units = 'in',res = 500)
ggplot()+theme_bw()+ggtitle('All Active Sites')+
  geom_polygon(data = wm,aes(x = long,y=lat,group=group),
               fill = 'gray80',lwd = 0.25)+
  layer_spatial(base.ster$base.dist)+
...
#save the base here
writeRaster(x = base,filename = './output/active/opt/base4/base_all_towers.tif',overwrite = T)
...
#create a path of file names
path = paste('./output/active/opt/base4/ext/',pca.towers1$sitename[ext],'.tif',sep = '')
#save off rasters
for (i in 1:length(dist.rasts)) {
  writeRaster(x = dist.rasts[[i]],filename = path[i],overwrite=T)
  progress(i,length(dist.rasts))
...
#save off difference maps
path = paste('./output/active/opt/base4/difs/',pca.towers1$sitename[ext],'_dif.tif',sep = '')
#save off rasters
for (i in 1:length(difs)) {
  writeRaster(x = difs[[i]],filename = path[i],overwrite=T)
  progress(i,length(difs))
...
png(filename = './output/active/opt/base4/barplot_reduction.png',width = 6,height = 4,units = 'in',res = 2000)
ggplot(data = top)+theme_bw()+ggtitle('Top 50 Percentile Improvements')+
  geom_bar(aes(reorder(site, -means*-1),means*-1,fill=country),stat = 'identity')+
  scale_y_continuous(expand = c(0,0),limits = c(0,0.08),'Mean ED Reduction')+
  scale_x_discrete('')+
...
write.csv(x = bars,file = './output/active/opt/base4/meanreduction.csv',row.names = F)
...
#plot
path = paste('./output/active/opt/base4/plots/',pca.towers1$sitename[ext],'_dif.png',sep = '')

#create a dataframe and reproject the tower locations for plotting
towers = SpatialPointsDataFrame(coords = pca.towers1[ext,c('x','y')],data = pca.towers1[ext,],proj4string = crs(base))
towers = spTransform(x = towers,CRSobj = proj)
towers.st = as.data.frame(towers)
...
###########################################
#add Resolute, kangiq, pond inlet, baker lake, and
...
png(filename = './output/active/opt/base5/base.png',width = 6,height = 6,units = 'in',res = 500)
ggplot()+theme_bw()+ggtitle('All Active Sites')+
  geom_polygon(data = wm,aes(x = long,y=lat,group=group),
               fill = 'gray80',lwd = 0.25)+
  layer_spatial(base.ster$base.dist)+
...
#save the base here
writeRaster(x = base,filename = './output/active/opt/base5/base_all_towers.tif',overwrite = T)
...
#create a path of file names
path = paste('./output/active/opt/base5/ext/',pca.towers1$sitename[ext],'.tif',sep = '')
#save off rasters
for (i in 1:length(dist.rasts)) {
  writeRaster(x = dist.rasts[[i]],filename = path[i],overwrite=T)
  progress(i,length(dist.rasts))
...
#save off difference maps
path = paste('./output/active/opt/base5/difs/',pca.towers1$sitename[ext],'_dif.tif',sep = '')
#save off rasters
for (i in 1:length(difs)) {
  writeRaster(x = difs[[i]],filename = path[i],overwrite=T)
  progress(i,length(difs))
...
png(filename = './output/active/opt/base5/barplot_reduction.png',width = 6,height = 4,units = 'in',res = 2000)
ggplot(data = top)+theme_bw()+ggtitle('Top 50 Percentile Improvements')+
  geom_bar(aes(reorder(site, -means*-1),means*-1,fill=country),stat = 'identity')+
  scale_y_continuous(expand = c(0,0),limits = c(0,0.08),'Mean ED Reduction')+
  scale_x_discrete('')+
...
write.csv(x = bars,file = './output/active/opt/base5/meanreduction.csv',row.names = F)
...
#plot
path = paste('./output/active/opt/base5/plots/',pca.towers1$sitename[ext],'_dif.png',sep = '')
...
#find columns which are active sites
pca.towers1$active = ifelse(pca.towers1$sitename == 'CEF cluster' |
                              pca.towers1$sitename == 'Resolute' |
                              pca.towers1$sitename == 'Kangiqsualujjuaq' |
                              pca.towers1$sitename == 'Pond Inlet' |
                              pca.towers1$sitename == 'Kular' |
                              pca.towers1$sitename == 'Batagai',
                            'active',pca.towers1$active)
...
png(filename = './output/active/opt/base6/base.png',width = 6,height = 6,units = 'in',res = 500)
ggplot()+theme_bw()+ggtitle('All Active Sites')+
  geom_polygon(data = wm,aes(x = long,y=lat,group=group),
               fill = 'gray80',lwd = 0.25)+
  layer_spatial(base.ster$base.dist)+
...
#save the base here
writeRaster(x = base,filename = './output/active/opt/base6/base_all_towers.tif',overwrite = T)
...
#create a path of file names
path = paste('./output/active/opt/base6/ext/',pca.towers1$sitename[ext],'.tif',sep = '')
#save off rasters
for (i in 1:length(dist.rasts)) {
  writeRaster(x = dist.rasts[[i]],filename = path[i],overwrite=T)
  progress(i,length(dist.rasts))
...
#save off difference maps
path = paste('./output/active/opt/base6/difs/',pca.towers1$sitename[ext],'_dif.tif',sep = '')
#save off rasters
for (i in 1:length(difs)) {
  writeRaster(x = difs[[i]],filename = path[i],overwrite=T)
  progress(i,length(difs))
...
png(filename = './output/active/opt/base6/barplot_reduction.png',width = 6,height = 4,units = 'in',res = 2000)
ggplot(data = top)+theme_bw()+ggtitle('Top 50 Percentile Improvements')+
  geom_bar(aes(reorder(site, -means*-1),means*-1,fill=country),stat = 'identity')+
  scale_y_continuous(expand = c(0,0),limits = c(0,0.08),'Mean ED Reduction')+
  scale_x_discrete('')+
...
write.csv(x = bars,file = './output/active/opt/base6/meanreduction.csv',row.names = F)
...
#plot
path = paste('./output/active/opt/base6/plots/',pca.towers1$sitename[ext],'_dif.png',sep = '')

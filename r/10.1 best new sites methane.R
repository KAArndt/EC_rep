...
#save the base here
writeRaster(x = base,filename = './output/improved_network/methane/improved_methane_1_tura.tif',overwrite = T)
...
#load in the base
base = rast('./output/improved_network/methane/improved_methane_1_tura.tif')
...
write.csv(x = bars,file = './output/reductions/meanreduction_remaining_methane_1_tura.csv',row.names = F)

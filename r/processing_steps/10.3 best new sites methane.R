...
#First addition ############################################################################################
#ranking of sites
ranks = read.csv(file = './data/reductions/meanreduction_remaining_methane_2.csv')
...
write.csv(x = bars,file = './data/reductions/meanreduction_remaining_methane_3.csv',row.names = F)

...
#First addition ############################################################################################
#ranking of sites
ranks = read.csv(file = './data/reductions/meanreduction_remaining_annual_4.csv')
...
write.csv(x = bars,file = './data/reductions/meanreduction_remaining_annual_5.csv',row.names = F)

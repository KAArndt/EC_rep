...
#First addition ############################################################################################
#ranking of sites
ranks = read.csv(file = './output/reductions/meanreduction_remaining_annual_methane_2.csv')
...
write.csv(x = bars,file = './output/reductions/meanreduction_remaining_annual_methane_3.csv',row.names = F)

...
#First addition ############################################################################################
#ranking of sites
ranks = read.csv(file = './output/reductions/meanreduction_remaining_methane_3_capebounty.csv')
names(ranks)[1] = 'site'
...
tower.data$methane  = ifelse(tower.data$site == "Tura" |
                             ...
                             tower.data$site == 'Spasskaya Pad (experimental forest)','methane',tower.data$methane)
...
#save the base here
writeRaster(x = base,filename = './output/improved_network/methane/improved_methane_4_spaskaya.tif',overwrite = T)
...
#load in the base
base = rast('./output/improved_network/methane/improved_methane_4_spaskaya.tif')
...
write.csv(x = bars,file = './output/reductions/meanreduction_remaining_methane_4_spaskaya.csv',row.names = F)

...
df$base.er1 = ifelse(df$base.dist <= 1.54,1,0)
df$base.er4 = ifelse(df$base.dist <= 1.27,1,0)

df$new.er1 = ifelse(df$improve <= 1.54,1,0)
df$new.er4 = ifelse(df$improve <= 1.27,1,0)

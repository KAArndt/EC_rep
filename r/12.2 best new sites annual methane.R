...
#First addition ############################################################################################
#ranking of sites
ranks = read.csv(file = './output/reductions/meanreduction_remaining_annual_methane_2_1987bonanza.csv')
names(ranks)[1] = 'site'
...
last = rast('./output/improved_network/annual_methane/improved_annual_methane_2_1987bonanza.tif')
...
#save the base here
writeRaster(x = base,filename = './output/improved_network/annual_methane/improved_annual_methane_3_zotto.tif',overwrite = T)
...
#load in the base
#base = rast('./output/improved_network/annual/improved_annual_methane_3_zotto.tif')
...
write.csv(x = bars,file = './output/reductions/meanreduction_remaining_annual_methane_2_1987bonanza.csv',row.names = F)

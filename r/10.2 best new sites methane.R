...
#First addition ############################################################################################
#ranking of sites
ranks = read.csv(file = './output/reductions/meanreduction_remaining_methane_1_tura.csv')
names(ranks)[1] = 'site'
...
tower.data$methane  = ifelse(tower.data$site == "Tura" |
                               tower.data$site == 'Bonanza Creek, 1987 Burn site near Delta Junction','methane',tower.data$methane)
tower.data$site
...
#save the base here
writeRaster(x = base,filename = './output/improved_network/methane/improved_methane_2_1987bonanza.tif',overwrite = T)
#base = rast('./output/improved_methane_1_tura.tif')
...
#load in the base
base = rast('./output/improved_network/methane/improved_methane_2_1987bonanza.tif')
...
write.csv(x = bars,file = './output/reductions/meanreduction_remaining_methane_2_1987bonanza.csv',row.names = F)

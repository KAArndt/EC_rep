...
net = which(pca.towers$active == 'active' & pca.towers$Start_CO2 < 2022 & pca.towers$Season_Activity == 'All year' & pca.towers$methane == 'methane')
...
#save the base here
writeRaster(x = base,filename = './output/annual_methane_2kmv2_min.tif',overwrite = T)

#######################################################################################
base = rast('./output/annual_methane_2kmv2_min.tif')

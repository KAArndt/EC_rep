...
#ranking of sites
ranks = read.csv(file = './output/meanreduction_remaining_mean_4_jackpine.csv')
...
#save the base here
writeRaster(x = base,filename = './output/improved_base_2kmv2_mean_5_ust_kuyga.tif',overwrite = T)
...
base = rast('./output/improved_base_2kmv2_mean_5_ust_kuyga.tif')
...
write.csv(x = bars,file = './output/meanreduction_remaining_mean_5_ustkuyga.csv',row.names = F)

...
#First addition ############################################################################################
#ranking of sites
ranks = read.csv(file = './output/reductions/meanreduction_remaining_methane_4.csv')
...
write.csv(x = bars,file = './output/reductions/meanreduction_remaining_methane_5.csv',row.names = F)

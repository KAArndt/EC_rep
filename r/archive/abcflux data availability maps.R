...
##########################################################################
# BASE
net = which(as.numeric(abcf$end_year) >= 2022 & abcf$active.2024 == 'active')
tower.data$site[net]
euci.net = euci[,c(net)]
...
#######################################################################################
##################     METHANE
net.methane = which(as.numeric(abcf$end_year) >= 2022 & abcf$active.2024 == 'active' & abcf$Flux == 'CO2 and CH4')

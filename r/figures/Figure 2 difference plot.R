...
#check out results to guide limits
hist(base.dif)
hist(methane.dif)
hist(annual.dif)
...
base.plot = ggplot()+theme_map()+
  ...
  scale_fill_gradientn('Improvement',
                       ...
                       oob = scales::squish)+  
   new_scale("fill") +
   geom_point(data = new.sites.active,aes(x,y,fill=methane.2024,pch=Season_Activity.2024,col=methane),col='black',show.legend = F,cex=1.2)+
...
methane.plot = ggplot()+theme_map()+
  ...
  scale_fill_gradientn('Improvement',
                       ...
                       oob = scales::squish)+  
  new_scale("fill") +
  geom_point(data = new.sites.ch4,aes(x,y,fill=methane.2024,pch=Season_Activity.2024),col='black',show.legend = F,cex=1.2)+
  scale_shape_manual(values = c(21,24),'Annual Cover',labels = c('Annual','Not Annual'))+
  scale_fill_manual(values = c('red','green3'))+
  scale_x_continuous(limits = c(-5093909,4542996))+
  scale_y_continuous(limits = c(-3687122,4374170))+
...
annual.plot = ggplot()+theme_map()+
  ...
  scale_fill_gradientn('Improvement',
                       ...
                       oob = scales::squish)+ 
  new_scale("fill") +
  geom_point(data = new.sites.annual,aes(x,y,fill=methane.2024,pch=Season_Activity.2024),col='black',show.legend = F,cex=1.2)+
...
annual.methane.plot = ggplot()+theme_map()+
  ...
  scale_fill_gradientn('Improvement',
                       ...
                       oob = scales::squish)+ 
  new_scale("fill") +
  geom_point(data = new.sites.annual.ch4,aes(x,y,fill=methane.2024,pch=Season_Activity.2024),col='black',show.legend = F,cex=1.2)+
  scale_shape_manual(values = c(21,2),'Annual Cover',labels = c('Annual','Not Annual'))+
...
#plot all 4 together
png(filename = './figures/figure_2_difference_plot.png',width = 6,height = 5,units = 'in',res = 1000)

...
#regular new sites ###########################################################################################
df1 = fread('./output/reductions/meanreduction_remaining_mean.csv')
df2 = fread('./output/reductions/meanreduction_remaining_mean_1.csv')
df3 = fread('./output/reductions/meanreduction_remaining_mean_2.csv')
df4 = fread('./output/reductions/meanreduction_remaining_mean_3.csv')
df5 = fread('./output/reductions/meanreduction_remaining_mean_4.csv')
df6 = fread('./output/reductions/meanreduction_remaining_mean_5.csv')
...
top = rbind(df1,df2,df3,df4,df5,df6)

#load in raster files
imp  = rast('./output/improved_network/improved_base_2kmv2_mean.tif')
imp1 = rast('./output/improved_network/next_five_sites/improved_base_2kmv2_mean_Yessey1.tif')
imp2 = rast('./output/improved_network/next_five_sites/improved_base_2kmv2_mean_khan_kentii_2.tif')
imp3 = rast('./output/improved_network/next_five_sites/improved_base_2kmv2_mean_chulman_3.tif')
imp4 = rast('./output/improved_network/next_five_sites/improved_base_2kmv2_mean_HJP75_jackpine.tif')
imp5 = rast('./output/improved_network/next_five_sites/improved_base_2kmv2_mean_5_ust_kuyga.tif')
...
#load in raster files
imp  = rast('./output/improved_network/improved_annual_2kmv2_mean.tif')
...
#load in raster files
imp  = rast('./output/improved_network/improved_methane_2kmv2_mean.tif')
...
#load in raster files
imp  = rast('./output/improved_network/improved_annual_methane_2kmv2_mean.tif')

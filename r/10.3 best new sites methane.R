...
#First addition ############################################################################################
#ranking of sites
ranks = read.csv(file = './output/reductions/meanreduction_remaining_methane_2_1987bonanza.csv')
names(ranks)[1] = 'site'
...
tower.data$methane  = ifelse(tower.data$site == "Tura" |
                             ...
                             tower.data$site == 'Cape Bounty','methane',tower.data$methane)
...
#save the base here
writeRaster(x = base,filename = './output/improved_network/methane/improved_methane_3_capebounty.tif',overwrite = T)
...
#load in the base
base = rast('./output/improved_network/methane/improved_methane_3_capebounty.tif')
...
write.csv(x = bars,file = './output/reductions/meanreduction_remaining_methane_3_capebounty.csv',row.names = F)

...
#save the base here
writeRaster(x = base,filename = './output/improved_network/annual/improved_annual_1_tura.tif',overwrite = T)
...
write.csv(x = bars,file = './output/reductions/meanreduction_remaining_annual_1_tura.csv',row.names = F)

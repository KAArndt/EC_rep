...
#First addition ############################################################################################
#ranking of sites
ranks = read.csv(file = './output/reductions/meanreduction_annual.csv')
...
write_csv(x = tower.data,'./data/next_5_sites/annual_1.csv')
...
orig = rast('./output/improved_network/improved_annual_2km.tif')
...
#save the base here
writeRaster(x = base,filename = './output/improved_network/next_five_sites/improved_annual_2km_1.tif',overwrite = T)
...
write.csv(x = bars,file = './output/reductions/meanreduction_remaining_annual_1.csv',row.names = F)

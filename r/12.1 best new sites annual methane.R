...
#First addition ############################################################################################
#ranking of sites
ranks = read.csv(file = './data/reductions/meanreduction_annual_methane.csv')
...
write.csv(x = bars,file = './data/reductions/meanreduction_remaining_annual_methane_1.csv',row.names = F)

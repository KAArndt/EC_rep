...
#First addition ############################################################################################
#ranking of sites
ranks = read.csv(file = './data/reductions/meanreduction_remaining_annual_1.csv')
...
write.csv(x = bars,file = './data/reductions/meanreduction_remaining_annual_2.csv',row.names = F)

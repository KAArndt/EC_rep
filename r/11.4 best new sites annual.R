...
#First addition ############################################################################################
#ranking of sites
ranks = read.csv(file = './data/reductions/meanreduction_remaining_annual_3.csv')
...
write.csv(x = bars,file = './data/reductions/meanreduction_remaining_annual_4.csv',row.names = F)

...
#ranking of sites
ranks = read.csv(file = './output/meanreduction_remaining_mean_2_khentii.csv')
...
#save the base here
writeRaster(x = base,filename = './output/improved_base_2kmv2_mean_chulman_3.tif',overwrite = T)
...
#load in the base
base = rast('./output/improved_base_2kmv2_mean_chulman_3.tif')
...
write.csv(x = bars,file = './output/meanreduction_remaining_mean_3_chulman.csv',row.names = F)

...
tower.data = fread(file = './data/next_5_sites/annual_2.csv')
...
orig = rast('./output/improved_network/next_five_sites/improved_annual_2km_2.tif')
...
#save the base here
writeRaster(x = base,filename = './output/improved_network/next_five_sites/improved_annual_2km_3.tif',overwrite = T)

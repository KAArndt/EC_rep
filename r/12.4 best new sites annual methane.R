...
#First addition ############################################################################################
#ranking of sites
ranks = read.csv(file = './output/reductions/meanreduction_remaining_annual_methane_3_zotto.csv')
names(ranks)[1] = 'site'
...
last = rast('./output/improved_network/annual_methane/improved_annual_methane_3_zotto.tif')
...
#save the base here
writeRaster(x = base,filename = './output/improved_network/annual_methane/improved_annual_methane_4_capebounty.tif',overwrite = T)
...
write.csv(x = bars,file = './output/reductions/meanreduction_remaining_annual_methane_4_capebounty.csv',row.names = F)

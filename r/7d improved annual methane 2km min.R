...
net = which(pca.towers$active == 'active' & pca.towers$Season_Activity == 'All year' & pca.towers$methane == 'methane')
...
#save the imp here
writeRaster(x = imp,filename = './output/imp_an_methane_2kmv2_min.tif',overwrite = T)

#######################################################################################
imp = rast('./output/imp_an_methane_2kmv2_min.tif')
...
new = subset(pca.towers,pca.towers$active == 'active' & pca.towers$Season_Activity == 'All year' & pca.towers$methane == 'methane')
old = subset(pca.towers,pca.towers$active == 'active' & pca.towers$Season_Activity == 'All year' & pca.towers$methane == 'methane' & pca.towers$Start_CO2 < 2022)
